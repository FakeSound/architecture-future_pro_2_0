...
output "stage_vm_id"          { value = module.staging_vm.vm_id }
output "stage_vm_external_ip" { value = module.staging_vm.external_ip }
output "stage_extra_disk_id"  { value = module.staging_vm.extra_disk_id }
